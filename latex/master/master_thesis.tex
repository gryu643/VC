...
{\Large \textbf{}}\\%\\:字下げ無し改行
\vspace{3mm}
{\Large \textbf{ベクトル符号化における送信電力制御適用型 \\固有ベクトル足切りアルゴリズム}} \\
...
\newpage
\rhead{\thepage}
\include{./chapter1/ch1} %序論
\include{./chapter2/ch2} %基本的概念の解説
\include{./chapter3/ch3} %PPLアルゴリズム解説
\include{./chapter4/ch4} %提案手法解説・検証
\include{./chapter5/ch5} %まとめ
\backmatter          %章番号をつけない          
\include{./chapter0/references} %参考文献
\include{./chapter0/acknowledgement} %謝辞
%\include{付録}
\end{document}
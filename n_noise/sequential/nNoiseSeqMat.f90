program seqMat_noiseNone
	...
	complex(kind(0d0)) :: XGLM(X_ROW,X_COL) !(SYMBL,SYMBL)
	complex(kind(0d0)) :: XGLMXGH(X_ROW,X_COL) !(SYMBL,SYMBL)
	...
	complex(kind(0d0)) :: D(X_COL,1)=(0.0,0.0)
	complex(kind(0d0)) :: D1(X_COL,1)=(0.0,0.0)
